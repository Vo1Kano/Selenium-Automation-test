...
public class Scenario2DeleteFromFav {
	static Logger logger = Logger.getLogger(Scenario2DeleteFromFav.class.getName());
	...
	public static void runScenario(WebDriver driver, ExtentTest test) throws InterruptedException {
		...
		System.out.println("Scenario2--------DeleteFromFavorites");
		...
		Utils.takeSnapShot(driver, "./screenshot/S2-1.png");
		...
		Utils.takeSnapShot(driver, "./screenshot/S2-2.png");
	    ...
	    //clicking on option in favorites to remove
		driver.manage().timeouts().implicitlyWait(1, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//*[@id=\"7b3083e7-1956-4f64-968b-920d938ba636\"]/div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[3]/i")).click();
		TimeUnit.SECONDS.sleep(1);
		Utils.takeSnapShot(driver, "./screenshot/S2-3.png");
		TimeUnit.SECONDS.sleep(2);
		...
		driver.findElement(By.xpath("//*[@id=\"7b3083e7-1956-4f64-968b-920d938ba636\"]/div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[3]/i")).click();
		TimeUnit.SECONDS.sleep(1);
		Utils.takeSnapShot(driver, "./screenshot/S2-4.png");
		TimeUnit.SECONDS.sleep(3);
		
		System.out.println("Scenario2--------DeleteFromFavorites----finished");
